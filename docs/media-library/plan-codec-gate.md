...
| 3 | [Thunder_Core#65](https://github.com/rdThunderThailand/Thunder_Core/issues/65) intake admission (2 RPCs + route) | Thunder_Core | #63 | done — migration applied + schema-verified on `develop` and prod; HTTP re-verified end-to-end on **both** `develop` and prod (High/Main cases, real browser upload) | [#70](https://github.com/rdThunderThailand/Thunder_Core/pull/70), landed via [#71](https://github.com/rdThunderThailand/Thunder_Core/pull/71) | 2026-09-17 |
...
| 6 | [Thunder_Core#67](https://github.com/rdThunderThailand/Thunder_Core/issues/67) backfill existing Assets | Thunder_Core | #64, #65, #66 + human "go" | held — prod recommended safe to go (0 of 3 condemned files airing), develop not recommended (4 of 6 airing); still waiting on the human "go" comment itself | — | 2026-09-17 |
