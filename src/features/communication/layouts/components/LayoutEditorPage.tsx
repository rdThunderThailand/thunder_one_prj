...
export function LayoutEditorPage({ layoutId }: { layoutId?: string | null }) {
  ...
  const goBack = () => {
    ...
    router.push("/communication/layouts");
  };
  ...
  if (loadError) {
    return (
      <Card className="p-6">
        ...
        <Button className="mt-4" variant="secondary" onClick={() => router.push("/communication/layouts")}>
          กลับไป Layouts
        </Button>
      </Card>
    );
    ...
    <div className="flex flex-col gap-6">
      ...
      {confirmLeave && (
        <UnsavedLeaveConfirm
          ...
          onLeave={() => router.push("/communication/layouts")}
        />
      )}
