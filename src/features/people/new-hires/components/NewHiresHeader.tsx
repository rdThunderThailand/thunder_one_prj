...
// Export stays inert (no backend) — "เพิ่มพนักงานใหม่" is real, opening
// AddEmployeeModal (see NewHiresPage).
export function NewHiresHeader({ onAddEmployee }: { onAddEmployee: () => void }) {
  return (
    <div className="flex flex-wrap items-start justify-between gap-4">
      <div>
        <h1 className="text-2xl font-semibold text-zinc-900 dark:text-zinc-50">เข้าใหม่</h1>
        <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
          ติดตามและจัดการกระบวนการเข้าใหม่ของพนักงาน
        </p>
      </div>
