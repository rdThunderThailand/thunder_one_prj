import { changeTabs, type ChangeTab } from "../mock-data";

interface ChangesTabsProps {
  active: ChangeTab["id"];
  onChange: (id: ChangeTab["id"]) => void;
}

// Real, client-side — same pattern as people/personnel's PersonnelTabs.
export function ChangesTabs({ active, onChange }: ChangesTabsProps) {
  return (
