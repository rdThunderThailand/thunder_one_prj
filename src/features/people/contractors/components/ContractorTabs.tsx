import { contractorTabs, type ContractorTab } from "../mock-data";
...
// Real, client-side filtering of `contractorRows` by status — same pattern
// as people/personnel's PersonnelTabs. Counts shown are the mockup's own
// header numbers (see mock-data.ts), not derived from the filtered rows.
export function ContractorTabs({ active, onChange }: ContractorTabsProps) {
  return (
