...
import { allocationTabs } from "../mock-data";

export function AllocationTabs({ children }: { children: React.ReactNode }) {
  const [active, setActive] = useState<(typeof allocationTabs)[number]>(allocationTabs[0]);
