...
import { countTabs } from "../mock-data";

export function CountTabs({ children }: { children: React.ReactNode }) {
  const [active, setActive] = useState<(typeof countTabs)[number]>(countTabs[0]);
