...
import { categoryDistribution } from "../mock-data";

export function CategoryDistributionCard() {
  return (
    <Card className="flex h-full flex-col p-4">
      <h2 className="mb-3 text-sm font-semibold text-zinc-900 dark:text-zinc-50">การกระจายตามประเภททรัพย์สิน</h2>
      <div className="flex flex-1 flex-col items-center gap-3">
        <div className="relative shrink-0">
          <DonutChart segments={categoryDistribution.segments} size={130} strokeWidth={16} />
          <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center">
            <span className="text-lg font-semibold text-zinc-900 dark:text-zinc-50">
              {categoryDistribution.total.toLocaleString()}
            </span>
