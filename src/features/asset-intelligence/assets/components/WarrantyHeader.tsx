...
// No real "create warranty/contract" flow exists yet — every header action
// here is inert.
  ...
  return (
    <div className="flex flex-col gap-3">
      <nav className="flex items-center gap-1.5 text-xs text-zinc-400">
        ...
        <span className="text-zinc-600 dark:text-zinc-300">Warranty / Lifecycle</span>
      </nav>
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold text-zinc-900 dark:text-zinc-50">Warranty / Lifecycle</h1>
          <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
            ติดตามการรับประกัน สัญญาบริการ และวงจรชีวิตทรัพย์สินตลอดอายุการใช้งาน
          </p>
        </div>
