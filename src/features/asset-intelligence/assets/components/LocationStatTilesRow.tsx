...
import { BuildingIcon, CurrencyIcon, GaugeIcon, GridIcon } from "@/components/ui/icons";
import { locationStatTiles, type LocationStatTileData } from "../mock-data";

const iconFor: Record<LocationStatTileData["icon"], React.ReactNode> = {
  building: <BuildingIcon />,
  buildingGreen: <BuildingIcon />,
  buildingAmber: <BuildingIcon />,
  grid: <GridIcon />,
  currency: <CurrencyIcon />,
  gauge: <GaugeIcon />,
};

export function LocationStatTilesRow() {
  return (
    <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
      {locationStatTiles.map((tile) => (
