...
import { transferTabs } from "../mock-data";

export function TransferTabs({ children }: { children: React.ReactNode }) {
  const [active, setActive] = useState<(typeof transferTabs)[number]>(transferTabs[0]);
