...
// `Asset` (a reusable media file) — see docs/adr/0017-asset-intelligence-feature-namespacing.md
 ...
 * docs/adr/0018-asset-device-cross-reference-model.md.
 */
...
export interface Asset {
   ...
   * exists — see docs/adr/0018-asset-device-cross-reference-model.md. Nothing
