...
import { BoxIcon, ChartIcon, ChevronRightIcon, MegaphoneIcon, UsersIcon } from "@/components/ui/icons";
import { managerRecentlyOpened, type ManagerWorkspaceIcon } from "../mock-data";

const iconFor: Record<ManagerWorkspaceIcon, React.ReactNode> = {
  megaphone: <MegaphoneIcon className="h-4 w-4" />,
  image: <BoxIcon className="h-4 w-4" />,
